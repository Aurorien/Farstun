...
//   fetch(
//     `https://api.papapi.se/lite/?query=${place}&format=json&apikey=ef43f09f7b0d31452c40181993ddb296e5ccf51f`
//   )
//     .then((response) => response.json())
//     .then((result) => {
...
// https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid=c154b34a121192ecd4e72a113661ad81
...
function fetchWeather(lon, lat) {
  // vädret just nu
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=se&units=metric&appid=c154b34a121192ecd4e72a113661ad81`
  )
    .then((response) => response.json())
    .then((now) => {
      console.log("weather", now);
...
function fetchForecast(lon, lat) {
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&lang=se&units=metric&appid=c154b34a121192ecd4e72a113661ad81`
  )
    .then((response) => response.json())
    .then((forecast) => {
